...
import { Menu, LogOut, Settings, Globe, Star } from 'lucide-react';
      ...
      <div className="flex-1 flex items-center justify-between max-w-screen-2xl mx-auto">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            <span className="font-medium text-gray-700">450 points</span>
          </div>
          <div className="hidden lg:flex items-center space-x-2">
            <div className="w-8 h-8 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg flex items-center justify-center transform hover:scale-105 transition-all">
